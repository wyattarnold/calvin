...
SOLVER='cbc'     # (string) Solver for Pyomo model
NPROC=1             # (int) Number of processors to allocate to each solver
NGEN=120             # (int) Number of evolutionary generations to conduct
MU=95               # (int) Population count
CHECKPOINT=None
...
if __name__ == "__main__":
    ...
    with MPIPoolExecutor() as executor:
        ...
        cosvfea.cosvf_ea_main(toolbox=toolbox, n_gen=NGEN, mu=MU, pwd=COSVF_DIR, checkpoint=CHECKPOINT)
